...
#STATS.PUSH
TEXT.SCROLL_UP:  
            @SET_ZP_WORD(ZP_PTR_TEXT_TGT,VICII_SCREEN_TEXT_LINE_00)
            @SET_ZP_WORD(ZP_PTR_TEXT_SRC,VICII_SCREEN_TEXT_LINE_01)
            @SET_ZP_WORD(ZP_PTR_COLOR_TGT,VICII_SCREEN_COLOR_LINE_00)
            @SET_ZP_WORD(ZP_PTR_COLOR_SRC,VICII_SCREEN_COLOR_LINE_01)
...
#STATS.POP
            ; Clear Bottom Line
            @SET_ZP_WORD(ZP_PTR_TEXT_TGT,VICII_SCREEN_TEXT_LINE_24)
